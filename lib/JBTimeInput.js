    ...
    */
    ...
    initWebComponent() {
        ...
        this.elements = {
            ...
            timePicker: {
                ...
                closeButton: this.shadowRoot.querySelector('.close-time-picker-button')
            },
        };
    ...
    onInputKeyDown(e) {
        ...
        if (e.keyCode == 38 || e.keyCode == 40) {
            ...
            if (this.secondEnabled && [...secondRange, secondRange[1] + 1].includes(carretPos)) {
    ...
    disableSecond() {
        ...
        this._inputValue = `${this.hourString}:${this.minuteString}`;
    }
    enableSecond() {
        this._inputValue = `${this.hourString}:${this.minuteString}:${this.secondString}`;
    }
}
